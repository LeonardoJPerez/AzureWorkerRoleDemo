...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="TestHangFireOnAzure" generation="1" functional="0" release="0" Id="dd6ed1ad-295d-4309-87e1-f508876ca28d" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
    <group name="TestHangFireOnAzureGroup" generation="1" functional="0" release="0">
      ...
      <components>
        <groupHascomponents>
          <role name="HangfireDashboardRole" generation="1" functional="0" release="0" software="C:\Source\TestHangFireOnAzure\TestHangFireOnAzure\csx\Release\roles\HangfireDashboardRole" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaWorkerHost.exe " memIndex="-1" hostingEnvironment="consoleroleadmin" hostingEnvironmentVersion="2">
            <componentports>
        ...
        <groupHascomponents>
          <role name="HangfireServerRole" generation="1" functional="0" release="0" software="C:\Source\TestHangFireOnAzure\TestHangFireOnAzure\csx\Release\roles\HangfireServerRole" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaWorkerHost.exe " memIndex="-1" hostingEnvironment="consoleroleadmin" hostingEnvironmentVersion="2">
            <settings>
              <aCS name="Microsoft.WindowsAzure.Plugins.Diagnostics.ConnectionString" defaultValue="" />
  ...
  <implements>
    <implementation Id="64d950b7-e562-4965-a9cd-c59dfc43e8f0" ref="Microsoft.RedDog.Contract\ServiceContract\TestHangFireOnAzureContract@ServiceDefinition">
      <interfacereferences>
        <interfaceReference Id="90b5df43-b729-401a-a0fd-4401ffdc45f3" ref="Microsoft.RedDog.Contract\Interface\HangfireDashboardRole:Endpoint1@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/TestHangFireOnAzure/TestHangFireOnAzureGroup/HangfireDashboardRole:Endpoint1" />
          </inPort>
        </interfaceReference>
